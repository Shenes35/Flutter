...
void main() {
  ...
  print("The concatenated string is: ${concatenate(value1 : value14,value2 : value15)}");
}
...
String concantenate({required String value1,required String value2,required String value3})