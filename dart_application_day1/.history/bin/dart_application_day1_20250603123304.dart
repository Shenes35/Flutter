import 'dart:io';
void main() {
  print("enter the mark1 mark2 and gracemark if vailable:");
  String? Input19 = stdin.readLineSync();
  double value19 = double.parse(Input19!);
  String? Input20 = stdin.readLineSync();
  double value20 = double.parse(Input20!);
  String? Input21 = stdin.readLineSync();
  double value21 = double.parse(Input21!);
  print("The mark is ${finalised(value1 : value19,value2 : value20, value3: value21)}");
  ...
  String? value16 = stdin.readLineSync();
  print("Enter your age:");
  String? value17 = stdin.readLineSync();
  print("Enter your city:");
  String? value18 = stdin.readLineSync();
  print("The generated string is: ${generate(name : value16,age : value17,city : value18)}");
...
String generate({String? name, String? age, String? city}) {
  return "My name is ${name ?? 'Unknown'} and my age is: ${age ?? 'Unknown'}. I am living in ${city ?? 'Unknown'} city.";
}

double finalised({required double value1,required double value2, double value3=0}){
  return value1+value2+value3;
}



Future<String> fetchDBData() async {
