...
void main() {
  ...
  int value14 = int.parse(Input14!);
  String? Input15 = stdin.readLineSync();
  int value15 = int.parse(Input15!);
  print("The sum of the numbers is ${sum(value1 : value14,value : value15)}");
}
...
int sum({required int value1,required int value2})