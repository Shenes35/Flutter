...
void main() {
  ...
  String? Input16 = stdin.readLineSync();
  String value16 = String.parse(Input16!);
  String? Input17 = stdin.readLineSync();
  String value17 = String.parse(Input17!);
  String? Input18 = stdin.readLineSync();
  String value18 = String.parse(Input18!);
...
String generate({required String name,required String age,required String city}){
  return ("My name is$name and my age is:$age.I am leaving in $city city");
}