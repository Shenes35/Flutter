...
void main() {
  ...
  print("The concatenated string is: ${concatenate(name : value16,age : value17,city : value18)}");
}
...
String concatenate({required String value1,required String value2,required String value3}){
