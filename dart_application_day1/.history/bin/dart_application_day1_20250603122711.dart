...
void main() {
  ...
  print("enter your name,age and city:");
  print("Enter your name:");
  String? value19 = stdin.readLineSync();
  print("Enter your age:");
  String? value20 = stdin.readLineSync();
  print("Enter your city:");
  String? value21 = stdin.readLineSync();
  print("The generated string is: ${generate(name : value,age : value17,city : value18)}");
