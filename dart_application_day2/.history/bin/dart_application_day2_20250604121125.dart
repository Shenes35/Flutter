...
void main(){
  List<Student2> student =[ 
    ...
    Set<int> seen = {};
    student.retainWhere((stu) => seen.add(stu.rollNo));
    print("Initial Student List:");
    student.forEach((student) => print(student));
    ...
    for (int i = 0; i < n; i++) {
      ...
      String name = String.parse(stdin.readLineSync()!);

      print("Enter the age:");
      int age = int.parse(stdin.readLineSync()!);

      print("Enter the name:");
      double totalMark = int.parse(stdin.readLineSync()!);
