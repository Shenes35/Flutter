...
class TaskPageupdate extends StatefulWidget {
  ...
  const TaskPageupdate({super.key, this.task});

  @override
  State<TaskPageupdate> createState() => _TaskInputPageState();
}

class _TaskInputPageState extends State<TaskPageupdate> {
  ...
  void initState() {
    ...
    // Prefill controllers with existing task values if editing
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'Edit Task',
          style: GoogleFonts.oxanium(fontWeight: FontWeight.bold),
        ),
      ),
      body: Padding(
